...
export function LandingPage({
  ...
  return (
    <main className="min-h-[100svh] bg-[#020617] text-[#171b25] lg:min-h-screen">
      <section className="relative grid min-h-[100svh] w-full overflow-x-hidden bg-[#050914] lg:min-h-screen lg:grid-cols-[minmax(390px,31vw)_minmax(0,1fr)] lg:overflow-hidden">
        <aside className="relative z-10 flex min-h-[100svh] flex-col bg-[#f7f5ef] px-7 py-6 sm:px-10 sm:py-9 lg:min-h-screen">
